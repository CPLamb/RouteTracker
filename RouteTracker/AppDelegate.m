...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (lastRead == nil)
    {
        ...
        [[NSUserDefaults standardUserDefaults] setInteger:0  forKey:@"selected_media_source"];
    ...
    [[NSUserDefaults standardUserDefaults] setObject:[NSDate date] forKey:dateKey];
     ...
     // loadData into memberArray singleton
    self.memberData = [[MemberListData alloc] init]; // singleton
    [self.memberData loadData];
